...
void main(){
    ...
    float tester = mod((coords.x + coords.y * 1.8 + sin(stime / 8.0 + coords.x / 5.0 - coords.y / 100.0) * 2.0) +
    sin(stime / 13.0 + coords.y / 5.0) * 1.0 +
    sin(stime / 6.0 - coords.y/2.0) * 2.0 +
    sin(stime / 12.0 + coords.y / 6.0) * 0.5 +
