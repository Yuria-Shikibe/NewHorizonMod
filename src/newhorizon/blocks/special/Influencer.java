...
public class Influencer extends Block {
	...
	public class InfluencerBuild extends Building implements Ranged {
		...
		protected void blast() {
			Rect rect = new Rect();
			if(generateLiNum > 0) PosLightning.create(this, target, team, lightningColor, PosLightning.WIDTH, 2, e ->{
		...
		protected void extra(){
			...
			PosLightning.createRange(this, team, range, gettingBoltNum, 2, lightningDamage < 0 ? damage : lightningDamage, lightningColor, true, PosLightning.WIDTH);
		}
