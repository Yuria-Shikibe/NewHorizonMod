    ...
    public class JumpGateBuild extends Building implements Ranged {
        ...
        public void updateTile(){
            ...
            if(isCalling()){
                ...
                if(this.buildReload >= getSet().costTime() && canSpawn(getSet())){
                    spawn(getSet());
                }
            }
        }
        ...
        public void drawConfigure() {
            ...
            if(coreValid()){
                Building core = core();
                DrawFuncs.posSquareLinkBottom(this, core, (isCalling() && !canSpawn(getSet())) ? baseColor().cpy().mul(Color.red) : baseColor(), 1.5f, 3.5f);
            }
            Draw.reset();
        }
