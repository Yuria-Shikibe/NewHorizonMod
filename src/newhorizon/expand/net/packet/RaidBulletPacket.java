...
public class RaidBulletPacket extends Packet {
    ...
    public int tintRgba = Color.white.rgba8888();
    ...
    public void handleClient() {
        ...
        if (team == null) return;
        Color tint = new Color().rgba8888(tintRgba);
        RaidBulletUtil.createSynced(type, team, x, y, angle, damage, velocityScl, lifetimeScl, aimX, aimY, tint, lightning, lightningLength, lightningDamage, bulletSpeed, bulletLifetime);
    }
}
