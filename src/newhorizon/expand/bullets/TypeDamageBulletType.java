...
public interface TypeDamageBulletType {
    ...
    default float getKineticMultiplier(BulletType type) {return 1f;}

    default float getEnergyMultiplier(BulletType type) {return type.shieldDamageMultiplier;}

    default float getKineticDamage(BulletType type) {return type.damage * getKineticMultiplier(type);}

    default float getEnergyDamage(BulletType type) {return type.damage * getEnergyMultiplier(type);}

    default float getSplashKineticDamage(BulletType type) {return type.splashDamage * getKineticMultiplier(type);}

    default float getSplashEnergyDamage(BulletType type) {return type.splashDamage * getEnergyMultiplier(type);}

    default float getContinuousKineticDamage(BulletType type) {return type.continuousDamage() * getKineticMultiplier(type);}

    default float getContinuousEnergyDamage(BulletType type) {return type.continuousDamage() * getEnergyMultiplier(type);}
