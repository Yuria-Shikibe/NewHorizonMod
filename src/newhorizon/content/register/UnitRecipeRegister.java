...
public class UnitRecipeRegister {
    public static void load(){
        ...
        unitRecipePlan(UnitBlock.jumpGateStandard, NHUnitTypes.naxos, 240 * 60f, recipe -> recipe.inputItem = ItemStack.list(NHItems.presstanium, 300, NHItems.metalOxhydrigen, 600, NHItems.seniorProcessor, 100, NHItems.multipleSteel, 300));
        unitRecipePlan(UnitBlock.jumpGateStandard, NHUnitTypes.tarlidor, 180 * 60f, recipe -> recipe.inputItem = ItemStack.list(Items.surgeAlloy, 300, NHItems.juniorProcessor, 500, NHItems.metalOxhydrigen, 600, NHItems.multipleSteel, 300));
        unitRecipePlan(UnitBlock.jumpGateStandard, NHUnitTypes.zarkov, 180 * 60f, recipe -> recipe.inputItem = ItemStack.list(Items.tungsten, 300, Items.surgeAlloy, 800, NHItems.metalOxhydrigen, 800, NHItems.multipleSteel, 400));
        ...
        unitRecipePlan(UnitBlock.jumpGateStandard, UnitTypes.navanax, 180 * 60f, recipe -> recipe.inputItem = ItemStack.list(Items.surgeAlloy, 600, NHItems.juniorProcessor, 200, NHItems.metalOxhydrigen, 600, NHItems.multipleSteel, 200));
        unitRecipePlan(UnitBlock.jumpGateStandard, UnitTypes.collaris, 240 * 60f, recipe -> recipe.inputItem = ItemStack.list(Items.phaseFabric, 400, Items.surgeAlloy, 400, Items.carbide, 300, NHItems.seniorProcessor, 100));

        unitRecipePlan(UnitBlock.jumpGateHyper, NHUnitTypes.destruction, 360 * 60f, recipe -> recipe.inputItem = ItemStack.list(NHItems.setonAlloy, 200, NHItems.irayrondPanel, 400, NHItems.seniorProcessor, 200, NHItems.thermoCoreNegative, 50));
        unitRecipePlan(UnitBlock.jumpGateHyper, NHUnitTypes.longinus, 180 * 60f, recipe -> recipe.inputItem = ItemStack.list(NHItems.multipleSteel, 100, NHItems.setonAlloy, 200, NHItems.irayrondPanel, 100, NHItems.thermoCoreNegative, 20));
        unitRecipePlan(UnitBlock.jumpGateHyper, NHUnitTypes.annihilation, 240 * 60f, recipe -> recipe.inputItem = ItemStack.list(NHItems.setonAlloy, 400, NHItems.irayrondPanel, 100, NHItems.thermoCoreNegative, 50));
        unitRecipePlan(UnitBlock.jumpGateHyper, NHUnitTypes.saviour, 360 * 60f, recipe -> recipe.inputItem = ItemStack.list(NHItems.zeta, 1000, NHItems.irayrondPanel, 600, Items.surgeAlloy, 500, NHItems.seniorProcessor, 200, NHItems.thermoCorePositive, 100));
        ...
        unitRecipePlan(UnitBlock.jumpGateHyper, NHUnitTypes.collapser, 600 * 60f, recipe -> recipe.inputItem = ItemStack.list(NHItems.nodexPlate, 3000, NHItems.ancimembrane, 2000, NHItems.thermoCorePositive, 2500, NHItems.thermoCoreNegative, 2500));
    }
