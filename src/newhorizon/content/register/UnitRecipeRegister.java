...
public class UnitRecipeRegister {
    public static void load(){
        ...
        unitRecipePlan(UnitBlock.jumpGatePrimary, UnitTypes.mega, 10 * 60f, recipe -> {
            recipe.inputItem = ItemStack.list(Items.silicon, 160, Items.titanium, 160, NHItem.zeta, 60);
        });
        unitRecipePlan(UnitBlock.jumpGatePrimary, UnitTypes.mega, 10 * 60f, recipe -> {
         ...
         unitRecipePlan(UnitBlock.jumpGatePrimary, UnitTypes.quasar, 10 * 60f, recipe -> {
            recipe.inputItem = ItemStack.list(Items.silicon, 180, Items.titanium, 180, NHItem.zeta, 80);
        });
        unitRecipePlan(UnitBlock.jumpGatePrimary, UnitTypes.quasar, 10 * 60f, recipe -> {
        ...
        unitRecipePlan(UnitBlock.jumpGatePrimary, NHUnitTypes.ghost, 10 * 60f, recipe -> {
            recipe.inputItem = ItemStack.list(Items.carbide, 120, NHItems.juniorProcessor, 200, NHItem.zeta, 120, NHItems, metalOxhydrigen, 80);
        });
        unitRecipePlan(UnitBlock.jumpGatePrimary, NHUnitTypes.ghost, 10 * 60f, recipe -> {
        ...
        unitRecipePlan(UnitBlock.jumpGatePrimary, NHUnitTypes.rhino, 10 * 60f, recipe -> {
            recipe.inputItem = ItemStack.list(Items.carbide, 200, NHItems.juniorProcessor, 200, NHItems, metalOxhydrigen, 100, Item.surgeAlloy, 180);
        });
        unitRecipePlan(UnitBlock.jumpGatePrimary, NHUnitTypes.rhino, 10 * 60f, recipe -> {
