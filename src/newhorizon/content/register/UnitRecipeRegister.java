...
public class UnitRecipeRegister {
    public static void load(){
        ...
        unitRecipePlan(UnitBlock.jumpGateStandard, NHUnitTypes.naxos, 180 * 60f, recipe -> PayloadStack.list(ModuleBlock.powerCell, 60, ModuleBlock.bionicsProcessor, 105, ModuleBlock.fusionReactor, 30));
        ...
        unitRecipePlan(UnitBlock.jumpGateStandard, NHUnitTypes.tarlidor, 135 * 60f, recipe -> PayloadStack.list(ModuleBlock.powerCell, 45, ModuleBlock.signalCirculator, 105, ModuleBlock.fusionReactor, 45));
        ...
        unitRecipePlan(UnitBlock.jumpGateStandard, NHUnitTypes.zarkov, 135 * 60f, recipe -> PayloadStack.list(ModuleBlock.coolingUnit, 420, ModuleBlock.powerCell, 60, ModuleBlock.fusionReactor, 30));
        ...
        unitRecipePlan(UnitBlock.jumpGateStandard, UnitTypes.eclipse, 135 * 60f, recipe -> PayloadStack.list(ModuleBlock.powerCell, 30, ModuleBlock.bionicsProcessor, 45, ModuleBlock.signalCirculator, 45));
        ...
        unitRecipePlan(UnitBlock.jumpGateStandard, UnitTypes.disrupt, 135 * 60f, recipe -> PayloadStack.list(ModuleBlock.supraGel, 120, ModuleBlock.powerCell, 30, ModuleBlock.signalCirculator, 60));
        ...
        unitRecipePlan(UnitBlock.jumpGateStandard, UnitTypes.corvus, 180 * 60f, recipe -> PayloadStack.list(ModuleBlock.bionicsProcessor, 60, ModuleBlock.fusionReactor, 30));
        ...
        unitRecipePlan(UnitBlock.jumpGateStandard, NHUnitTypes.tarlidor, 135 * 60f, recipe -> PayloadStack.list(ModuleBlock.signalCirculator, 40, ModuleBlock.fusionReactor, 90));
        ...
        unitRecipePlan(UnitBlock.jumpGateStandard, UnitTypes.collaris, 180 * 60f, recipe -> PayloadStack.list(ModuleBlock.powerCell, 90, ModuleBlock.bionicsProcessor, 30, ModuleBlock.signalCirculator, 30));
        ...
        unitRecipePlan(UnitBlock.jumpGateHyper, NHUnitTypes.destruction, 240 * 60f, recipe -> PayloadStack.list(ModuleBlock.bionicsProcessor, 60, ModuleBlock.fusionReactor, 45, ModuleBlock.resistoArray, 60));
        ...
        unitRecipePlan(UnitBlock.jumpGateHyper, NHUnitTypes.longinus, 120 * 60f, recipe -> PayloadStack.list(ModuleBlock.signalCirculator, 45, ModuleBlock.quantumConductor, 6));
        ...
        unitRecipePlan(UnitBlock.jumpGateHyper, NHUnitTypes.annihilation, 160 * 60f, recipe -> PayloadStack.list(ModuleBlock.fusionReactor, 40, ModuleBlock.resistoArray, 40, ModuleBlock.quantumConductor, 40));
        ...
        unitRecipePlan(UnitBlock.jumpGateHyper, NHUnitTypes.saviour, 240 * 60f, recipe -> PayloadStack.list(ModuleBlock.fusionReactor, 60, ModuleBlock.quantumConductor, 60, ModuleBlock.particleModulator, 120));
        ...
        unitRecipePlan(UnitBlock.jumpGateHyper, NHUnitTypes.declining, 240 * 60f, recipe -> PayloadStack.list(ModuleBlock.fusionReactor, 180, ModuleBlock.resistoArray, 180, ModuleBlock.pulseMutator, 120));
        ...
        unitRecipePlan(UnitBlock.jumpGateHyper, NHUnitTypes.hurricane, 240 * 60f, recipe -> PayloadStack.list(ModuleBlock.fusionReactor, 200, ModuleBlock.quantumConductor, 200, ModuleBlock.particleModulator, 400));
        ...
        unitRecipePlan(UnitBlock.jumpGateHyper, NHUnitTypes.anvil, 160 * 60f, recipe -> PayloadStack.list(ModuleBlock.pulseMutator, 200, ModuleBlock.particleModulator, 200));
