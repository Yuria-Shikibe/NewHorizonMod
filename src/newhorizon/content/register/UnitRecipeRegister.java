...
public class UnitRecipeRegister {
    public static void load(){
        ...
        unitRecipePlan(UnitBlock.jumpGateHyper, NHUnitTypes.longinus, 180 * 60f, recipe -> recipe.inputItem = ItemStack.list(NHItems.multipleSteel, 100, NHItems.setonAlloy, 500, NHItems.irayrondPanel, 10));
