...
public class RecipeRegister {
    public static void load(){
        input(CraftingBlock.stampingFacility, recipe -> {
            ...
            recipe.inputPayload = PayloadStack.list(ModuleBlock.heatDetector, 0.5);
            recipe.craftScl = 8f;
            recipe.boostScl = 0.5f;
        });
        input(CraftingBlock.stampingFacility, recipe -> {
            recipe.inputItem = ItemStack.list(Items.titanium, 3);
            recipe.inputPayload = PayloadStack.list(ModuleBlock.armorCast, 0.5);
            recipe.craftScl = 4f;
            recipe.boostScl = 0.5f;
        });
        input(CraftingBlock.stampingFacility, recipe -> {
        ...
        input(CraftingBlock.processorPrinter, recipe -> {
            ...
            recipe.inputPayload = PayloadStack.list(ModuleBlock.powerUnit, 0.5);
            recipe.craftScl = 8f;
            recipe.boostScl = 0.5f;
        });
        input(CraftingBlock.processorPrinter, recipe -> {
            recipe.inputItem = ItemStack.list(Items.silicon, 3);
            recipe.inputPayload = PayloadStack.list(ModuleBlock.wiringKit, 0.5);
            recipe.craftScl = 4f;
            recipe.boostScl = 0.5f;
        });
        input(CraftingBlock.processorPrinter, recipe -> {
        ...
        input(CraftingBlock.crucibleFoundry, recipe -> {
            ...
            recipe.inputPayload = PayloadStack.list(ModuleBlock.protonCapacitor, 0.5);
            recipe.craftScl = 8f;
            recipe.boostScl = 0.5f;
        });
        input(CraftingBlock.crucibleFoundry, recipe -> {
            recipe.inputItem = ItemStack.list(Items.tungsten, 2);
            recipe.inputPayload = PayloadStack.list(ModuleBlock.crystalDiode, 0.5);
            recipe.craftScl = 4f;
            recipe.boostScl = 0.5f;
        });
        input(CraftingBlock.crucibleFoundry, recipe -> {
        ...
        input(CraftingBlock.crystallizer, recipe -> {
            ...
            recipe.inputPayload = PayloadStack.list(ModuleBlock.coolingUnit, 0.5);
            recipe.craftScl = 8f;
            recipe.boostScl = 0.5f;
        });
        input(CraftingBlock.crystallizer, recipe -> {
        ...
        input(CraftingBlock.crystallizer, recipe -> {
            recipe.inputLiquid = LiquidStack.list(NHLiquids.xenFluid, 4 / 60f);
            recipe.inputPayload = PayloadStack.list(ModuleBlock.supraGel, 0.5);
            recipe.craftScl = 4f;
            recipe.boostScl = 0.5f;
        });
        input(CraftingBlock.crystallizer, recipe -> {
